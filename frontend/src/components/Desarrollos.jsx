        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {t.items.map((dev, i) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <div className="text-[10px] tracking-[0.18em] uppercase text-[#7A9BB5] font-sans mb-2">
                  {dev.type}
                </div>
                <h3 className="text-xl font-serif text-[#EEF2F8] mb-2 group-hover:text-[#D9AE4E] transition-colors duration-300">
                  {dev.title}
                </h3>
                ...
                <p className="text-sm text-[#7A9BB5] font-sans font-light leading-relaxed mb-5">
                  {dev.description}
                </p>
